...
import dora.lifecycle.activity.AppVisibilityActivityLifecycle
import dora.lifecycle.application.ApplicationLifecycleCallbacks

class AppVisibilityGlobalConfig : GlobalConfig {
    ...
    override fun injectActivityLifecycle(
        ...
        lifecycles.add(AppVisibilityActivityLifecycle())
    }
